 ...
 */
async function getSlotsForVetDay({ vetId, date, duration }) {
    ...
    for (const { startTime, endTime } of vet.availability) {
        ...
        while ((0, date_fns_1.addMinutes)(cursor, duration) <= windowEnd) {
            candidates.push(cursor);
            cursor = (0, date_fns_1.addMinutes)(cursor, duration);
        }
    }
 ...
 */
async function getClinicSlotsForDay({ clinicId, date, duration, vetId }) {
