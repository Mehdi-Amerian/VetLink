...
import { BaseResolver, formatProblems, getTotals, detectSpec, bundleDocument, isRef, dequal, logger, isString, isPlainObject, keysOf, isEmptyObject, } from '@redocly/openapi-core';
...
export async function handleJoin({ argv, config, version: packageVersion, collectSpecData, }) {
    ...
    function collectPaths(openapi, { apiFilename, apiTitle, api, potentialConflicts, tagsPrefix, componentsPrefix, }, serversAreTheSame) {
